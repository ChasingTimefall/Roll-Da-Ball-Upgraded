...
public class SucessLevelInterface : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(vecScreenSize.x / 2f - 70, vecScreenSize.y / 2f - 60, 200, 30), "You completed the level!");

        if (RenderButton("Play again", new Vector2(vecScreenSize.x / 2f, vecScreenSize.y / 2f), new Vector2(90, 30)))
        {
